import { TaskList, TaskRow } from '@/components/task';
...
import { findEarliestDate, findLatestDate, getMonthsBetween } from '@/utils';
import {
  addDays,
  addHours,
  addMinutes,
...
const GanttChart = React.forwardRef(
  (
    ...
    useImperativeHandle(ref, () => ({
      ...
      getTimelineGrid: () => timelineGridRef.current,
    }));
        ...
        <div className='rmg-container' data-rmg-component='container'>
          {renderTaskList ? (
            ...
            <TaskList
              ...
              viewMode={activeViewMode}
              showTooltipGroup={showTooltipGroup}
              renderTooltipGroup={renderTooltipGroup}
            />
          )}
